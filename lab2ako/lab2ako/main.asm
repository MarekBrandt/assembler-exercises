...
tytul_zadanie dw 'Z','n','a','k','i',0
tekst_zadanie dw 'T','o',' ','j','e','s','t',' ','p','i','e','s',' ',0D83DH, 0DC36H,' ','i',' ','k','o','t',' ',0D83Dh,0DE38H,0
.code
_main PROC
 push 0 ; sta³a MB_OK
...
; adres obszaru zawieraj¹cego tekst
 ...
 push 0
 push OFFSET tytul_zadanie
 push OFFSET tekst_zadanie
 push 0
 call _MessageBoxW@16
