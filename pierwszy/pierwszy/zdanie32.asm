...
; obliczenie bez u¿ycia pêtli rozkazowej
     ...
     add eax, 5 ; dodanie drugiego
     add eax, 7 ; dodanie trzeciego
     add eax, 9 ; dodanie czwartego
     add eax, 11 ; dodanie pi¹tego
...
ptl: add eax, ebx ; dodanie kolejnego elementu
     ...
     sub ecx, 1 ; zmniejszenie licznika obiegów pêtli
